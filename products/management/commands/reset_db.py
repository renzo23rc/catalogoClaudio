...
class Command(BaseCommand):
    help = 'BORRA todo y regenera desde AGCOM'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('4/4 Importando desde AGCOM...')
        call_command('import_agcom')
        call_command('normalize_images')
        ...
        self.stdout.write(self.style.SUCCESS('\n✅ TODO LISTO. Corré: python manage.py runserver'))
